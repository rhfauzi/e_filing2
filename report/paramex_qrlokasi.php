...
<div class="panel-heading">Parameter Print Excel For QRCode Lokasi
...
<div><i class="ketmenu">Utility <i class="fa fa-arrow-right"></i>&nbsp; Get Excel Lokasi</i></div><br>
<form name="form1" method="POST" action="report/downex.php?type=ex_qrlok&print=1&nm=Ex_QRLokasi">
				...
				<div class="panel panel-info">
				    ...
				    <div class="panel-body" align="justify">
				        <p style="font-size:12px">
				        	~ <b>Parameter Print Excel For QRCode Lokasi </b>  ini digunakan untuk memilih data lokasi yang akan di download file excelnya dimana file excel tersebut terdapat kode atau link yang akan dirubah menjadi QRCode pada software pendukung pencetakan QRCode. <br><br>
				        	~ <b> Pilih Kode Lokasi </b> pada combo box Kode Lokasi untuk menentukan lokasi yang akan didownload data lokasi nya<br><br>
