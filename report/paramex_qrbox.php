...
<div class="panel-heading">Parameter Print Excel For QRCode BOX
...
<div><i class="ketmenu">Utility <i class="fa fa-arrow-right"></i>&nbsp; Get Excel Box</i></div><br>
<form name="form1" method="POST" action="report/downex.php?type=ex_qrbox&print=1&nm=Ex_QRBox">
				...
				<div class="panel panel-info">
				    ...
				    <div class="panel-body" align="justify">
				        <p style="font-size:12px">
				        	~ <b>Parameter Print Excel For QRCode BOX </b>  ini digunakan untuk memilih data box yang akan di download file excelnya dimana file excel tersebut terdapat kode atau link yang akan dirubah menjadi QRCode pada software pendukung pencetakan QRCode. <br><br>
