...
<h3>Informasi Box <?php echo "<b><i>'".$id."'</i></b>"; ?></h3>
...
<thead>
	...
	<?php
		...
		$Query	=	mssql_query("SELECT row_number() over (order by id_arsip) as no, kd_arsip from arsip where kd_box = '".$id."'");
