...
$(document).ready(function() {
	...
	$('#simpan').click(function(){
		...
		if(alasan == '0' || alasan == ''){
			...
			$('#RB').focus();
		}else if(LL == LBsplit && RL == RB){
			window.alert('Kode Lokasi,Kode Rak masih sama tidak ada yang berbeda. Mohon teliti kembali');
		}else if(tgl_pindah == ''){
			...
			if(confirm('ANDA YAKIN INGIN MENYIMPAN DATA ?')){
				$.ajax({
					type:"POST",
					data:"act=pindahbox&kd_box="+kd_box+"&alasan="+alasan+"&RL="+RL+"&LB="+LB+"&RB="+RB+"&keterangan="+keterangan+"&tgl_pindah="+tgl_pindah,
...
<div class="panel-heading">Form Tambah Pemindahan Box (<i><b>step 3</b></i>)
	<div style="float:right;">
	<?php
	$url1   = "mid=menupindah";
	$urlEnc1 = $edc->encrypt($url1,true);
	$url2   = "mid=addpindah_box_next&kd_lokasi=".$kd_lokasi."&kd_rak=".$kd_rak;
...
<table width="100%" border="0px">
	<tr>
		<td colspan="5" align="right">
			...
			?>
			<i>Kode Box </i> : <?php echo "<b>".$kd_box."</b>"; ?>
	...
	<tr>
		<td>Rak Lama</td>
		<td><input readonly type='text' id='RL' name='RL' class="form-control ukuran5" value="<?php echo $kd_rak;?>"></td>
		<td>Rak Baru</td>
		<td>
	...
	<div class="panel panel-info">
	    ...
	    <div class="panel-body" align="justify">
	        <p style="font-size:12px">
	        	~ Form ini adalah untuk menginput data perpindahan Box pada ruang arsip <br>
...
<div class="modal-dialog" style="width:800px;">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title">Pilih Lokasi tujuan pemindahan Box</h4>
