...
<?php
$url1   = "mid=addpindah_rak";$urlEnc1 = $edc->encrypt($url1,true);
...
<thead>
	<tr>
		...
		<th width="5%"><font style='color:green;'>LL</font></th>
		<th width="5%"><font style='color:green;'>LB</font></th>
...
<tbody>
	...
	$no =1;
		...
		$QueMain	=	mssql_query("SELECT a.*,b.alasan FROM hist_pindah_rak a,msalasan_pindah b where a.alasan_pindah=b.kode_alasan");
	...
	<tr>
		...
		<td><?php echo $res['lokasi_awal'];?></td>
		<td><?php echo $res['lokasi_akhir'];?></td>
	...
	<div class="panel panel-info">
	    ...
	    <div class="panel-body">
	        <p style="font-size:12px">
	        	~ Menu pemindahan Rak digunakan untuk melihat history data pemindahan rak<br>
	        	~ 	<font style='color:green;'><b>LL</b></font> = Lokasi Lama,
					<font style='color:green;'><b>LB</b></font> = Lokasi Baru
	        </p>
	    </div>
	</div>
</div>
