...
<div class="modal-dialog" style="width: 800px">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
       <table width="100%" class="datatable-1 table table-bordered table-striped display" id="dataArsip_pindah">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode Lokasi</th>
	...
	$(document).ready(function() {
            ...
            var dataTable = $('#dataArsip_pindah').DataTable( {
                responsive: true,
                "order": [[ 0, "desc" ]],
                "processing": true,
                "serverSide": true,
                "ajax":{
                    ...
                    error: function(){  
                        $(".lookup-error").html("");
                        $("#dataArsip_pindah").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                        $("#dataArsip_pindah_processing").css("display","none");
                    }
                }
            } ); 
           // end Datatable
