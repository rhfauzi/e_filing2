...
<?php
if(in_array($level,$arr_group_editor)){ //jika level super admin / PIC / PIC plus
?>
...
<tbody>
	...
	<tr>
		...
		?>
		<td><?php echo "<a href='main.php?".$urlEnc."'>".$res["kd_arsip"]."</a>"; ?></td>
...
<div class="modal-dialog" style='width:800px;'>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
       <table width="100%" class="datatable-1 table table-bordered table-striped display" id="pindah_dt">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode Arsip</th>
	...
	$(document).ready(function() {
            ...
            var dataTable = $('#pindah_dt').DataTable( {
                responsive: true,
                "order": [[ 0, "desc" ]],
                "processing": true,
                "serverSide": true,
                "ajax":{
                    url :"pages/process_pindaharsip.php", 
                    type: "post", 
                    
                    error: function(){  
                        $(".lookup-error").html("");
                        $("#pindah_dt").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                        $("#pindah_dt_processing").css("display","none");
                    }
                }
            } ); 
           // end Datatable
